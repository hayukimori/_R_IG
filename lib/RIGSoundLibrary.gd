extends Node
class_name RIGSoundLibrary

# TODO: Abstract library to repo, and let this file as SoundService.
static var sound_library := {
    "alert0": preload("res://assets/audio/s1.wav"),
    "alert1": preload("res://assets/audio/alert1.wav")
}

static func get_sound_by_name(sound_name: String) -> AudioStream:
